      ...
      <div className="my-12 container  px-4 lg:ml-16 lg:w-2/3">
        ...
        <div className="my-8">
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            <div className="flex item-start gap-2 bg-bmshow-50 p-3 border-yellow-300 border-dashed border-2 rounded-xl">
            ...
            <div className="flex item-start gap-2 bg-bmshow-50 p-3 border-yellow-300 border-dashed border-2 rounded-xl">
              ...
              <div className="flex flex-col items-start">
                <h3 className="text-gray-800 text-xl font-bold">Filmy Pass</h3>
                <p className="text-gray-600 text-sm">
